Expomobile::Application.configure do
...
#  }
  ...
  config.action_mailer.default_url_options = { :host => 'expomobile.com.mx' } 
  ...
  ActionMailer::Base.smtp_settings = {
    ...
    :address => 'mail.expomobile.com.mx',
    :port => 587,
    :domain => 'expomobile.com.mx',
    :authentication => :login,
    :user_name => 'no-reply@expomobile.com.mx',
    :password => 'emobilej2011'
  }
